...
final class WorkPiMarkdownSaveCoordinator: @unchecked Sendable {
...
///
/// The synchronous methods on `WorkPiMarkdownEditorState` remain available to
...
@MainActor
extension WorkPiMarkdownEditorState {
