...
@MainActor
final class WorkPiMarkdownChangeBuffer {
    ...
    @discardableResult
    func restore(_ snapshot: WorkPiMarkdownChangeSnapshot) -> Bool {
    ...
    func snapshot(
        ...
        return WorkPiMarkdownChangeSnapshot(
            url: url,
            baseHash: baseHash,
            baseText: baseText,
...
struct WorkPiMarkdownChangeSnapshot: Equatable, Sendable {
    let url: URL
    let baseHash: String
    let baseText: String
