...
extension WorkPiNodeArtifact {
    static func verify(
        ...
        guard normalizedExpected.count == 64,
            ...
            throw WorkPiRuntimeProvisioningError.verificationFailed("官方校验和格式无效。")
        }
        ...
        guard fileManager.fileExists(atPath: archiveURL.path),
              ...
              size >= 0,
              size <= Int64(WorkPiRuntimePolicy.maxNodeArchiveBytes)
        else {
            throw WorkPiRuntimeProvisioningError.verificationFailed("Node.js 下载文件大小无效。")
        }
        ...
        do {
            ...
            throw WorkPiRuntimeProvisioningError.verificationFailed("无法读取 Node.js 下载文件。")
        }
        defer { try? handle.close() }
        ...
        while true {
            ...
            do {
                ...
                throw WorkPiRuntimeProvisioningError.verificationFailed("读取 Node.js 下载文件失败。")
            }
