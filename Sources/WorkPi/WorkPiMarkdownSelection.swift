...
/// 一个块内的 UTF-16 光标端点。
struct WorkPiMarkdownSelectionEndpoint: Equatable {
    let blockID: UUID
    let offset: Int
}
...
struct WorkPiMarkdownSelection: Equatable {
    ...
    ) -> (start: WorkPiMarkdownSelectionEndpoint, end: WorkPiMarkdownSelectionEndpoint)? {
