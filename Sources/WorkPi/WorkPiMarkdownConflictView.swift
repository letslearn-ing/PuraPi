...
@MainActor
struct WorkPiMarkdownConflictBar: View {
    @Environment(\.workPiTheme) private var theme
    @State private var showingDiff = false

    let conflict: WorkPiMarkdownEditorState.Conflict
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingDiff) {
            WorkPiMarkdownConflictDiffView(
                localText: localText,
...
@MainActor
private struct WorkPiMarkdownConflictDiffView: View {
