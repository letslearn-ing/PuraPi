...
struct RuntimeHUD: View {
    ...
    private var modelOptions: [WorkPiHUDMenuOption] {
    ...
    private var thinkingLevelOptions: [WorkPiHUDMenuOption] {
    ...
    static func displayThinkingLevel(
        _ level: String,
        language: WorkPiInterfaceLanguage = .chinese
    ) -> String {
        ...
        labelContent
            ...
            .background {
                GeometryReader { proxy in
                    if isEnabled {
                        WorkPiHUDMenu(options: options, onSelect: onSelect)
