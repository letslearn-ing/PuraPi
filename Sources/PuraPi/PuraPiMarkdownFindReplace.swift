...
@MainActor
final class PuraPiMarkdownFindReplaceState: ObservableObject {
...
@MainActor
struct PuraPiMarkdownFindReplaceBar: View {
    @ObservedObject var state: PuraPiMarkdownFindReplaceState
