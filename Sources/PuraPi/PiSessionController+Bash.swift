    ...
    func abortBashCommand() {
        ...
        Task { [weak self] in
            do {
                ...
                self.lastError = "无法中止命令：\(PuraPiSensitiveText.redacted(error.localizedDescription))"
            }
        }
    }
    ...
    func consumeBashResponse(_ record: PiRPCRecord) -> Bool {
        ...
        case "bash":
            ...
            guard record.success == true else {
                finishBashExecution(
                    id: id,
                    state: .rejected(message: PuraPiSensitiveText.redacted(
        ...
        case "abort_bash":
            ...
            if record.success != true {
                ...
                activeBashAbortCommandID = nil
                lastError = PuraPiSensitiveText.redacted(
