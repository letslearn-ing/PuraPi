...
///
/// macOS 26 由 `PuraPiWorkspaceSplitViewController` 管理原生三栏；这条 legacy
/// 路径只负责在 SwiftUI HStack 中装配同一份 Inspector 内容。
@MainActor
struct PuraPiAttachedInspector: View {
    ...
    var body: some View {
        ...
        .padding(.top, PuraPiLayoutState.inspectorSurfaceTopInset)
