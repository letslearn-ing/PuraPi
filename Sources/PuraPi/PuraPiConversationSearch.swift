...
/// 对话内搜索的状态与匹配逻辑。
@MainActor
final class PuraPiConversationSearchState: ObservableObject {
...
extension Notification.Name {
    /// Cmd+F：打开对话内搜索。
    static let puraPiFindInConversation = Notification.Name("PuraPi.findInConversation")
}
...
@MainActor
struct PuraPiConversationSearchBar: View {
