...
final class PuraPiScrollEdgeEffectView: NSView {
    ...
    private static let materialMaskImage: NSImage = {
        let height = Int(PuraPiScrollEdgeEffectView.height)
        guard let rep = NSBitmapImageRep(
            ...
            return NSImage(size: NSSize(width: 1, height: PuraPiScrollEdgeEffectView.height))
        }
        ...
        let image = NSImage(
            size: NSSize(width: 1, height: PuraPiScrollEdgeEffectView.height)
        )
