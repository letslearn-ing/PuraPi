...
@MainActor
final class PuraPiMarkdownNavigationTests: XCTestCase {
    ...
    private func makeDocument(_ text: String) throws -> (URL, URL) {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("purapi-markdown-navigation-\(UUID().uuidString)", isDirectory: true)
    ...
    private func close(_ window: NSWindow, hosting: NSHostingView<PuraPiMarkdownEditorView>) {
        window.orderOut(nil)
