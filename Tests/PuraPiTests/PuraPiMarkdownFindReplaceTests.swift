...
@MainActor
final class PuraPiMarkdownFindReplaceTests: XCTestCase {
    func testFindStateMatchesAcrossBlocksAndWrapsNavigation() {
        ...
        let state = PuraPiMarkdownFindReplaceState()
        state.query = "alpha"
    ...
    func testCommandFOpensEditorFindBar() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("purapi-markdown-find-ui-\(UUID().uuidString)", isDirectory: true)
