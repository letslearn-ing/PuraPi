...
@MainActor
final class WorkPiMarkdownInlinePresentationTests: XCTestCase {
    func testUnfocusedPresentationHidesMarkersAndAppliesInlineStyles() {
        ...
        let result = WorkPiMarkdownInlinePresentation.render(
            source: source,
    ...
    func testRenderedBlockBecomesEditableBeforeTextInput() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-inline-focus-\(UUID().uuidString)")
    ...
    func testEditorTogglesInlineMarkersWithoutChangingSource() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-inline-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
