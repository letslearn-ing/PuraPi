...
@MainActor
final class WorkPiMarkdownTableTests: XCTestCase {
    func testTableParserPreservesAlignmentAndEscapedPipes() {
        let source = "| 名称 | 说明 |\n| :--- | ---: |\n| A\\|B | `x|y` |"
        let table = WorkPiMarkdownTableModel(source: source)
    ...
    func testEditingTableCellsAndStructureSerializesSafely() {
        let source = "| A | B |\n| --- | --- |\n| 1 | 2 |"
        var table = WorkPiMarkdownTableModel(source: source)
    ...
    func testTableModelNeverRemovesTheLastColumn() {
        var table = WorkPiMarkdownTableModel(source: "| A |\n| --- |\n| 1 |")
    ...
    func testTableEditorExposesEditableCellsAndWritesCellChanges() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-markdown-table-editor-\(UUID().uuidString)", isDirectory: true)
        ...
        (header.delegate as? WorkPiMarkdownTableCellEditor.Coordinator)?
...
private extension WorkPiMarkdownTableTests {
