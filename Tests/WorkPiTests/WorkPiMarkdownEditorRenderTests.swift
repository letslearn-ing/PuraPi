...
@MainActor
final class WorkPiMarkdownEditorRenderTests: XCTestCase {
    func testEmptyMarkdownFileProvidesAnEditableFirstRow() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-empty-editor-\(UUID().uuidString)")
    ...
    func testDeletingTheOnlyParagraphKeepsAnEmptyFirstResponderAtStart() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-delete-empty-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testDeleteCharactersOneByOneKeepsSelectionAtStart() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-delete-one-by-one-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testClickingAnUnfocusedBlockMakesItEditableImmediately() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-click-focus-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testClickingRenderedInlineTextMapsCaretBackToSourceOffset() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-inline-click-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testDraggingAcrossRenderedInlineTextPreservesSourceSelection() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-inline-drag-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testSequentialTypingKeepsCaretAfterInsertedCharacters() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-sequential-typing-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testEditingInTheMiddleKeepsCaretAfterTheInsertedText() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-middle-edit-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testBlockMarkerConversionPreservesCaretAtEnd() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-marker-typing-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testTypingInlineMarkersDoesNotMoveCaretOrLoseText() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-inline-typing-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testMarkedTextIsNotRewrittenAndCommittedChineseTextReachesModel() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-marked-text-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testReturnInEmptyDocumentMovesFocusToTheNewLine() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-empty-return-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testChineseCompositionCanCreateTheFirstBlockInAnEmptyFile() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-empty-ime-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testMarkedTextDoesNotLeakWhenFocusMovesToAnotherBlock() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-marked-focus-change-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testWhitespaceOnlyMarkdownFileProvidesAnEditableRow() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-whitespace-editor-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
