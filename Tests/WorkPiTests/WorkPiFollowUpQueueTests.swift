...
@MainActor
final class WorkPiFollowUpQueueTests: XCTestCase {
    ...
    private func makeSession() throws -> (PiSessionController, FakePiRPCTransport, URL) {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("WorkPi-queue-\(UUID().uuidString)", isDirectory: true)
    ...
    private func waitUntil(
        ...
        XCTFail("Timed out waiting for WorkPi queue state")
    }
