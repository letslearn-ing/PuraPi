...
@MainActor
final class WorkPiMarkdownInlineEditingTests: XCTestCase {
    ...
    func testCommandKeyEquivalentRoutesToMarkdownFormat() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-markdown-key-equivalent-\(UUID().uuidString)", isDirectory: true)
    ...
    func testInlineShortcutChangesDocumentSourceThroughEditor() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("workpi-markdown-shortcut-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
...
private extension WorkPiMarkdownInlineEditingTests {
